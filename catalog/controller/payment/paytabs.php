  ...
  public function success() {
	...
	$this->load->model('checkout/order');
      ...
      if (isset($_SESSION['api_key'])) {
		 ...
		 $response_data = $this->sendRequest('https://www.paytabs.com/api/verify_payment',$request_string);
	...
	public function send() {
        ...
        $this->load->model('checkout/order');
	       ...
	       foreach ($this->cart->getProducts() as $product) {
	        	...
	        	$price_total     =  $product['total']; //$this->currency->format($product['total'], $this->currency->getCode(), $this->currency->getValue());
	        	//$product['total'];
		   ...
		   $payment_data = array(
			...
			'amount'               => $this->currency->format($order_info['total'], false, false, false),
            ...
            "unit_price"           => $this->currency->format($order_info['total'], false, false, false),
		 ...
		 $response_data = $this->sendRequest('https://www.paytabs.com/api/create_pay_page', $request_string1);
		 $object = json_decode($response_data);
